...
import { generateEmailTemplate, cleanEmailBody } from '../services/geminiService';
...
const TemplatesView: React.FC = () => {
    ...
    const handleAiGenerate = async () => {
        ...
        try {
            ...
            setFormData(prev => ({ ...prev, subject: result.subject, body: cleanEmailBody(result.body, result.subject) }));
