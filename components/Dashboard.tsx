...
import { 
  BarChart, DollarSign, Target, Trophy, Puzzle, PieChart, CloudUpload 
} from 'lucide-react';
  ...
  return (
    ...
    >
        ...
        <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="glass-panel rounded-2xl p-6 relative overflow-hidden group border-t border-yellow-500/20 md:col-span-1"
            >
                 ...
                 <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="p-2 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 shadow-[0_0_10px_rgba(234,179,8,0.2)]"><Trophy className="w-5 h-5" /></div>
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="glass-panel rounded-2xl p-6 relative overflow-hidden group border-t border-indigo-500/20 md:col-span-1"
            >
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="p-2 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 shadow-[0_0_10px_rgba(99,102,241,0.2)]"><DollarSign className="w-5 h-5" /></div>
                </div>
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="glass-panel rounded-2xl p-6 relative overflow-hidden group border-t border-emerald-500/20 md:col-span-1"
            >
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.2)]"><Target className="w-5 h-5" /></div>
                </div>
                ...
                <div className="w-full bg-slate-800/50 h-1.5 rounded-full overflow-hidden relative z-10">
                     <motion.div 
                        ...
                        className={`h-full rounded-full ${stats.avgScore > 70 ? 'bg-gradient-to-r from-emerald-600 to-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-gradient-to-r from-yellow-600 to-yellow-400'}`} 
                     />
                </div>
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="glass-panel rounded-2xl p-6 relative overflow-hidden group border-t border-blue-500/20 md:col-span-1"
            >
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="p-2 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-400 shadow-[0_0_10px_rgba(59,130,246,0.2)]"><CloudUpload className="w-5 h-5" /></div>
                </div>
                <div className="mb-4 relative z-10 flex items-baseline gap-1">
                ...
                <div className="w-full bg-slate-800/50 h-1.5 rounded-full overflow-hidden relative z-10">
                     <motion.div 
                        initial={{ width: 0 }}
                        animate={{ width: `${(stats.crmSynced / Math.max(leads.length, 1)) * 100}%` }}
            ...
            <motion.div 
              ...
              className="md:col-span-4 glass-panel rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-8 relative overflow-hidden"
            >
                ...
                <div className="relative z-10 flex flex-col gap-2 min-w-[150px]">
                    <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2"><PieChart className="w-4 h-4 text-indigo-500" /> Industrias</h3>
        ...
        <motion.div 
          ...
          className="glass-panel rounded-2xl p-6 flex flex-col h-full border-t border-purple-500/20"
        >
             <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                 <Puzzle className="w-4 h-4 text-purple-400" /> Logros
             </h3>
                 ...
                 {BADGES.map(badge => {
                     ...
                     return (
                         <motion.div 
                           ...
                           key={badge.id} 
                           className={`flex items-center gap-3 p-3 rounded-xl border transition-all duration-300 ${isUnlocked ? 'bg-purple-500/10 border-purple-500/30 shadow-[0_0_10px_rgba(168,85,247,0.1)]' : 'bg-white/5 border-white/5 opacity-40 grayscale'}`}
                         >
